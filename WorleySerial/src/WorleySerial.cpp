...
void PerformanceCheck(const std::string outfile, const int width, const int height,
		         const int tile_size, const int points_per_tile, const float intensity, int seed, const bool reverse) {
...
int main (int argc, char **argv) {
	...
	if(!performance) {
		...
		PerformanceCheck(out, width, height, tile_size, points_per_tile, intensity, seed, inverse);
	}
